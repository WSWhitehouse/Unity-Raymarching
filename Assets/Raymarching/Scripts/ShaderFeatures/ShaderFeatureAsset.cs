...
public abstract class ShaderFeatureAsset : ScriptableObject
{
  #region GUID
...
#if UNITY_EDITOR
[CustomEditor(typeof(ShaderFeatureAsset))]
public class ShaderFeatureEditor : Editor
{
  private ShaderFeatureAsset Target => target as ShaderFeatureAsset;
