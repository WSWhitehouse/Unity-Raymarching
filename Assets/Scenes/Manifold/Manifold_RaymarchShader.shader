...
//
//    Time Generated: 10/28/2021 14:24:07
//---------------------------------------------------------------------
...
// LIGHTING SETTINGS END //
    ...
    // Raymarch Variables
uniform int _IsActivecf4078b7d61b45d6ace9948b40ccf2ae;
...
float distance5f6229b977e74e23a6188ffac9ca59bd = _RenderDistance;
float4 colour5f6229b977e74e23a6188ffac9ca59bd = float4(1,1,1,1);

float3 position76a474ff47de44e18867d4da2622a330 = Rotate3D((rayPos - _Position76a474ff47de44e18867d4da2622a330) / _Scale76a474ff47de44e18867d4da2622a330, _Rotation76a474ff47de44e18867d4da2622a330);
...
distance5f6229b977e74e23a6188ffac9ca59bd = distance76a474ff47de44e18867d4da2622a330;
colour5f6229b977e74e23a6188ffac9ca59bd = _Colour76a474ff47de44e18867d4da2622a330;

float3 position10518fb76e9e4d378c4899d9f6c3e2c9 = Rotate3D((rayPos - _Position10518fb76e9e4d378c4899d9f6c3e2c9) / _Scale10518fb76e9e4d378c4899d9f6c3e2c9, _Rotation10518fb76e9e4d378c4899d9f6c3e2c9);
...
float3 position11c01ce4dcfe4716876d3f4e6b5e7037 = Rotate3D((rayPos - _Position11c01ce4dcfe4716876d3f4e6b5e7037) / _Scale11c01ce4dcfe4716876d3f4e6b5e7037, _Rotation11c01ce4dcfe4716876d3f4e6b5e7037);
float distance11c01ce4dcfe4716876d3f4e6b5e7037 = _RenderDistance;
if (_IsActive11c01ce4dcfe4716876d3f4e6b5e7037 > 0)
{
distance11c01ce4dcfe4716876d3f4e6b5e7037 = SDF_Capsule_6dd9ace8ea81468da4fe7ff03e5332bb(position11c01ce4dcfe4716876d3f4e6b5e7037, _a11c01ce4dcfe4716876d3f4e6b5e7037, _b11c01ce4dcfe4716876d3f4e6b5e7037, _r11c01ce4dcfe4716876d3f4e6b5e7037) * _Scale11c01ce4dcfe4716876d3f4e6b5e7037;
...
float distanceba84b4c5b4fc440ba4e9604d566be8dc = _RenderDistance;
float4 colourba84b4c5b4fc440ba4e9604d566be8dc = float4(1,1,1,1);

float3 positionef0db21fb328435ebac0fb203090cbd7 = Rotate3D((rayPos - _Positionef0db21fb328435ebac0fb203090cbd7) / _Scaleef0db21fb328435ebac0fb203090cbd7, _Rotationef0db21fb328435ebac0fb203090cbd7);
float distanceef0db21fb328435ebac0fb203090cbd7 = _RenderDistance;
if (_IsActiveef0db21fb328435ebac0fb203090cbd7 > 0)
{
distanceef0db21fb328435ebac0fb203090cbd7 = SDF_Capsule_6dd9ace8ea81468da4fe7ff03e5332bb(positionef0db21fb328435ebac0fb203090cbd7, _aef0db21fb328435ebac0fb203090cbd7, _bef0db21fb328435ebac0fb203090cbd7, _ref0db21fb328435ebac0fb203090cbd7) * _Scaleef0db21fb328435ebac0fb203090cbd7;
distanceef0db21fb328435ebac0fb203090cbd7 /= _MarchingStepAmountef0db21fb328435ebac0fb203090cbd7;

}

distanceba84b4c5b4fc440ba4e9604d566be8dc = distanceef0db21fb328435ebac0fb203090cbd7;
colourba84b4c5b4fc440ba4e9604d566be8dc = _Colouref0db21fb328435ebac0fb203090cbd7;

// Operation Start Oper_Cut ab63694457d54834b7ea550dfcc959dd
float distanceab63694457d54834b7ea550dfcc959dd = _RenderDistance;
float4 colourab63694457d54834b7ea550dfcc959dd = float4(1,1,1,1);

float3 positiond223265320814ba299e3ea035de051f4 = Rotate3D((rayPos - _Positiond223265320814ba299e3ea035de051f4) / _Scaled223265320814ba299e3ea035de051f4, _Rotationd223265320814ba299e3ea035de051f4);
float distanced223265320814ba299e3ea035de051f4 = _RenderDistance;
if (_IsActived223265320814ba299e3ea035de051f4 > 0)
{
distanced223265320814ba299e3ea035de051f4 = SDF_Capsule_6dd9ace8ea81468da4fe7ff03e5332bb(positiond223265320814ba299e3ea035de051f4, _ad223265320814ba299e3ea035de051f4, _bd223265320814ba299e3ea035de051f4, _rd223265320814ba299e3ea035de051f4) * _Scaled223265320814ba299e3ea035de051f4;
distanced223265320814ba299e3ea035de051f4 /= _MarchingStepAmountd223265320814ba299e3ea035de051f4;

}

distanceab63694457d54834b7ea550dfcc959dd = distanced223265320814ba299e3ea035de051f4;
colourab63694457d54834b7ea550dfcc959dd = _Colourd223265320814ba299e3ea035de051f4;

float3 position43ed3c7c5c124db3bbf62a5add8b1d48 = Rotate3D((rayPos - _Position43ed3c7c5c124db3bbf62a5add8b1d48) / _Scale43ed3c7c5c124db3bbf62a5add8b1d48, _Rotation43ed3c7c5c124db3bbf62a5add8b1d48);
...
float3 position656acc72441243959155b9e6545de517 = Rotate3D((rayPos - _Position656acc72441243959155b9e6545de517) / _Scale656acc72441243959155b9e6545de517, _Rotation656acc72441243959155b9e6545de517);
float distance656acc72441243959155b9e6545de517 = _RenderDistance;
if (_IsActive656acc72441243959155b9e6545de517 > 0)
{
distance656acc72441243959155b9e6545de517 = SDF_Capsule_6dd9ace8ea81468da4fe7ff03e5332bb(position656acc72441243959155b9e6545de517, _a656acc72441243959155b9e6545de517, _b656acc72441243959155b9e6545de517, _r656acc72441243959155b9e6545de517) * _Scale656acc72441243959155b9e6545de517;
...
resultColour   = colourba84b4c5b4fc440ba4e9604d566be8dc;
    ...
    float4 GetLight(float3 pos, float3 normal)
    {
      ...
      light += GetDirectionalLight(pos, normal, float4(1, 0.9568627, 0.8392157, 1), float3(-0.3213938, -0.7660444, 0.5566705), 1);
